 ...
 */
    ...
    /**
     * 
     * @param {object} employee - accepts an Employee object and set it employee list 
     */
    ...
    */
    promptUser(q){
     ...
     /**
     * @async
     * @function typeOfEmployee - will check what type of employee need to be created; ask question to send data to matching function to create that object
    ...
    /**
     * @async
     * @function createEmp -  create Employee then add it to employee list
     * @fires this.promptUser - ask user for special attribute based on employee
     * @fires this.setEmployeeList - add Employee to employee list
     ...
     * @param {class} empType - Class constructor
     */
    ...
    /**
     * @async
     * @function anotherEmployee - will ask question to user if then want to create another employee
